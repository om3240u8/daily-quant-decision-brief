"""
Fetch U.S. Treasury yield curve.
Primary: Treasury.gov daily CMT. Fallback: WSJ Bonds page, then last snapshot.
"""
...
def fetch_treasury_cmt(year=None):
